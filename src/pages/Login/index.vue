<template>
    <div class="login-container">
            ...
            <div class="login">
                <div class="loginform">
                    <ul class="tab clearFix">
                        <li><a href="#" style="border-right:0;">扫码登录</a></li>
        ...
        <div class="copyright">
            <ul>
                <li>关于我们</li><li>联系我们</li><li>联系客服</li>
                <li>商家入驻</li><li>营销中心</li><li>手机尚品汇</li>
                <li>销售联盟</li><li>尚品汇社区</li>
            </ul>
            <div class="address">地址：合肥市经济开发区锦绣大道99号</div>
            <div class="beian">皖ICP备1314520号</div>
        </div>
    </div>
</template>
